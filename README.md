...
* 🏷️ **Segmentación por Géneros:** Al cruzar las tablas de categorías, se detectó el impacto total en minutos de visualización de géneros clave (como *Action* y *Sci-Fi*), permitiendo al departamento de compras saber qué inventario genera mayor retención de tiempo.
* 🚨 **Control de Pérdidas e Inventario:** Mediante filtros dinámicos (`IS NULL`), localizamos a los clientes con alquileres fuera de plazo (como la búsqueda específica realizada para la clienta *Tammy Sanders*), facilitando las tareas de reclamación de devoluciones.
...
## 🤝 6. Contribuciones
Las contribuciones son totalmente bienvenidas. Si encuentras una forma más optimizada de resolver alguno de los scripts o quieres añadir nuevas consultas analíticas, por favor abre un *pull request* o genera una *issue*.

## 👤 7. Autores
* **Zhaklina Dobromirova Karailieva ** - [zhaklinaa](https://github.com/zhaklinaa)
* *Proyecto formativo de SQL Avanzado.*
